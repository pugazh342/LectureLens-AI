...
# You will need to get an API key from Google AI Studio: https://makersuite.google.com/app/apikey
# Add it to your .env file as: GOOGLE_API_KEY="YOUR_GEMINI_API_KEY_HERE"
...
# --- Streamlit UI ---
st.set_page_config(page_title="AI-Powered Tutor", layout="centered")
...
if st.session_state.video_processed or st.session_state.chat_history or st.session_state.available_languages:
    if st.button("🔄 Clear Current Video & Chat"):
        ...
        # Removed st.experimental_rerun() here
        # A rerun will naturally occur due to button click and state changes
